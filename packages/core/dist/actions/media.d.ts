...
import type { BaseField, CollectionWithDefaults, Entry, MediaField, UnknownField } from '../interface';
...
export declare function getAsset<T extends MediaField, EF extends BaseField = UnknownField>(collection: CollectionWithDefaults<EF> | null | undefined, entry: Entry | null | undefined, path: string, field?: T, currentFolder?: string): (dispatch: ThunkDispatch<RootState, {}, AnyAction>, getState: () => RootState) => Promise<AssetProxy>;
