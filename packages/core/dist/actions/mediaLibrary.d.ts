...
import type { BaseField, CollectionWithDefaults, CollectionFileWithDefaults, Field, ImplementationMediaFile, MediaField, MediaFile, MediaLibrarInsertOptions, MediaLibraryConfig, UnknownField } from '../interface';
...
export declare function openMediaLibrary<EF extends BaseField = UnknownField>(payload?: {
    ...
    readonly payload: {
        ...
        readonly collectionFile: CollectionFileWithDefaults<UnknownField>;
