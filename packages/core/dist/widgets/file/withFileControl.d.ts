...
import type { FileOrImageField, WidgetControlProps } from '@staticcms/core';
...
declare const withFileControl: ({ forImage }?: WithFileControlProps) => React.FC<WidgetControlProps<string | string[], FileOrImageField, import("@staticcms/core").ObjectValue>>;
