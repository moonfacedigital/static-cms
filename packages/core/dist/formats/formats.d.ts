import type { BaseField, CollectionWithDefaults, Entry } from '../interface';
...
export declare function resolveFormat<EF extends BaseField>(collection: CollectionWithDefaults<EF>, entry: Entry): FileFormatter | undefined;
